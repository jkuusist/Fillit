...
/*   Updated: 2019/12/05 10:18:30 by lharvey          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	// ADDING THIS COMMENT / CODE, TO BE REMOVED AT A LATER DATE
		if (solver(binary_map) == 0)
			return (0);
	// BECAUSE IT SHOULD ALWAYS SUCCEED FROM HERE ON 
	else
		write(1, "error\n", 6);
	close(fd);
	return (0);
